      ...
      <section className="bg-white py-20">
        <div className="mx-auto w-11/12 max-w-7xl flex flex-col gap-10">
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex flex-col pt-8 text-center lg:w-full w-1/2 gap-10">
              <h1 className="bg-gradient-to-br from-purple-500  via-pink-500 to-orange-500 bg-clip-text text-4xl font-semibold  ">
                Our Founding Story
              </h1>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10">
            <div className="flex flex-col lg:w-1/2 gap-10">
              <h1 className="bg-gradient-to-b from-red-500 to-orange-500 bg-clip-text text-4xl font-semibold text-center">
                Our Vision
              </h1>
              <p className="text-base font-medium text-gray-700">
            ...
            <div className="flex flex-col lg:w-1/2 gap-10">
              <h1 className="bg-gradient-to-b from-blue-500 via-teal-300 to-green-300 bg-clip-text text-4xl font-semibold  text-center">
                Our Mission
              </h1>
              <p className="text-base font-medium text-gray-700">
